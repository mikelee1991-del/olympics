  ...
  return (
    <div className="page">
      ...
      <section className="hero" id="top" aria-labelledby="hero-brand">
        <div className="hero-copy">
          ...
          <p className="hero-lede">
            Track medal leaders and pin the nations you care about as the Games
            unfold.
          </p>
          <div className="hero-actions">
            <a className="btn btn-primary" href="#standings">
              View standings
            </a>
      ...
      <footer className="footer">
        <p>Olympics demo app — sample medal data for local development.</p>
      </footer>
    </div>
  )
}
